...
const stepThroughCell = (row, column) => {
  ...
  // Asswmble randomly ordered list of neighbors
...
// Iterate over horizontals and verticals to create walls

// Remember, horizantals is a 2d array; it will return another array
// that we will call as 'row' and then iterate over that array
// same goes for verticals
